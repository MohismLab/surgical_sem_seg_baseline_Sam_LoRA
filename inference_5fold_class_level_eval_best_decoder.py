...
OUT_BASE = "/mnt/hdd2/task2/sam_lora/class_eval_5fold_best_decoder"
RANK = 2
DEVICE = "cuda:0"
...
log.info(f"5-Fold Class-Level Evaluation (BEST weights). Total instances per fold: {len(prompt_index)}")
...
# Save summary CSV
summary_csv = os.path.join(OUT_BASE, "summary_5fold_best.csv")
