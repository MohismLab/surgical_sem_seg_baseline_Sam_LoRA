...
OUT_BASE = "/mnt/hdd2/task2/sam_lora/class_eval_5fold_Si5_final_decoder"   # ← final
RANK = 2
DEVICE = "cuda:0"
...
FOLD_CKPT = {
    0: "/mnt/hdd2/task2/sam_lora/exp_9/lora_rank2_30_epoch_in_100_epochs_final_9.safetensors",
    1: "/mnt/hdd2/task2/sam_lora/exp_10/lora_rank2_24_epoch_in_100_epochs_final_10.safetensors",
    2: "/mnt/hdd2/task2/sam_lora/exp_11/lora_rank2_48_epoch_in_100_epochs_final_11.safetensors",
    3: "/mnt/hdd2/task2/sam_lora/exp_12/lora_rank2_31_epoch_in_100_epochs_final_12.safetensors",
    4: "/mnt/hdd2/task2/sam_lora/exp_13/lora_rank2_39_epoch_in_100_epochs_final_13.safetensors",
}
...
# ============================================================
def main():
    log.info(f"5-Fold Class-Level Evaluation on Si5 — FINAL weights. Patients: {TEST_PATIENTS}")
